...
public class TextSearchFunctionFactory implements FunctionFactory {
    ...
    public Function newInstance(
        ...
        try (SqlCompiler compiler = engine.getSqlCompiler()) {
            ...
            return new CursorFunction(new TextSearchRecordCursorFactory(base, tableToken.getTableName(), columnName, limit));
        } catch (Throwable th) {
            Misc.free(base);
            throw th;
        }
    ...
    private static class TextSearchRecordCursorFactory extends AbstractRecordCursorFactory {
        ...
        private TextSearchRecordCursorFactory(RecordCursorFactory base, CharSequence tableName, CharSequence columnName, long limit) {
        ...
        public void toPlan(PlanSink sink) {
            sink.type("text_search scan fallback");
